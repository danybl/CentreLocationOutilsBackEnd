...
{
    public class ExistingReservationException : Exception
    {
        /**
      ...
      */
        public ExistingReservationException() : base() { }
        /**
       ...
       */
        public ExistingReservationException(string message) : base(message) { }
    }
}
